    ...
    <form action={dispatch}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter your Jira credentials to connect your account. Your API token is stored securely.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="domain" name="domain" type="text" placeholder="your-company.atlassian.net" required aria-describedby="domain-error" />
          ...
          <div className="space-y-2">
            ...
            <Input id="apiToken" name="apiToken" type="password" required aria-describedby="apiToken-error" />
            <div id="apiToken-error" aria-live="polite" aria-atomic="true">
              {state.errors?.apiToken && state.errors.apiToken.map((error: string) => (
                <p className="mt-2 text-sm text-destructive" key={error}>{error}</p>
              ))}
            </div>
          </div>
